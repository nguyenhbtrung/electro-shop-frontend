                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={4}>
                            <Typography variant="body2">
                                - Loại: {discountInfo.type === 'Percentage' ? 'Phần trăm' : 'Số tiền cố định'}
                                ({discountInfo.type === 'Percentage' ? `${discountInfo.value}%` : formatPrice(discountInfo.value)})
                            </Typography>
                        </Grid>
                        <Grid item xs={4}>
                            <Typography variant="body2">
...
function DiscountManagerTest() {
    ...
    const [discountInfo, setDiscountInfo] = useState({
        ...
        endDate: '2023-06-30',
        selectedProductIds: ['1004', '1005']
    });

    const handleSaveSelected = (selectedProducts) => {
...
export default DiscountManagerTest;